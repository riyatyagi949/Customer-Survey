...
3) Run Tests: To run the unit tests and ensure the application is functioning as expected:
...
1) ~ .env: Update the .env file to include your API URL and any other environment-specific variables.

2) src/config/theme.js: Modify the theme settings to customize the appearance of your surveys.
